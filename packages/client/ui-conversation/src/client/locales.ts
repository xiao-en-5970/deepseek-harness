...
export const zh = {
  ...
  'stats.cost': '本对话约 {cost}',
  'stats.workspaceCost': '本工作区约 {cost}',
  'stats.identifierCost': '当前标识符约 {cost}',
  ...
  'message.cost': '本回答约 {cost}',
  'message.costDetail': '按 DeepSeek 返回的 token 用量及请求开始时对应的北京时间峰谷价格计算',
...
export const en = {
  ...
  'stats.workspaceCost': 'Workspace ≈ {cost}',
  'stats.identifierCost': 'Identifier ≈ {cost}',
  ...
  'message.tokensPerSecond': '{tps} tok/s',
  'message.cost': 'This reply ≈ {cost}',
  'message.costDetail': 'Calculated from DeepSeek-reported tokens and the Beijing-time peak/off-peak price at request start',
