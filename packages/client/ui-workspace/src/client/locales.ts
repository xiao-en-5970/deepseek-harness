...
export const zh = {
  ...
  'files.retry': '重试',
  'files.empty': '此目录为空',
  'files.truncated': '此目录内容过多，仅显示前部分。',
  'files.newFile': '新建文件',
  'files.newFolder': '新建目录',
  'files.upload': '上传文件',
  'files.refresh': '刷新文件列表',
  'files.download': '下载“{name}”',
  'files.target': '目标目录：{name}',
  'files.fileName': '文件名',
  'files.folderName': '目录名',
  'files.create': '创建',
  'files.cancel': '取消',
  'files.uploading': '正在上传 {done}/{total} 个文件…',
  'files.tree.aria': '当前工作区文件',
...
export const en = {
  ...
  'files.truncated': 'This directory has more entries. Only the first entries are shown.',
  ...
  'files.create': 'Create',
  'files.cancel': 'Cancel',
  'files.uploading': 'Uploading {done}/{total} files…',
  'files.tree.aria': 'Current Workspace files',
