...
export interface RpcMethodMap {
  ...
  'host.listWorkspaceFiles': HostApi['listWorkspaceFiles']
  'host.createFile': HostApi['createFile']
  'host.beginDirectoryUpload': HostApi['beginDirectoryUpload']
  'host.writeDirectoryUpload': HostApi['writeDirectoryUpload']
  'host.completeDirectoryUpload': HostApi['completeDirectoryUpload']
  'host.abortDirectoryUpload': HostApi['abortDirectoryUpload']
  'host.beginFileUpload': HostApi['beginFileUpload']
  'host.writeFileUpload': HostApi['writeFileUpload']
  'host.completeFileUpload': HostApi['completeFileUpload']
  'host.abortFileUpload': HostApi['abortFileUpload']
